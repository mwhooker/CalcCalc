...
//fix that hack? would itself be a hack -- maybe
//todo: make sure calculator is on screen
//fix ShellExecute function
//BUG: opens 2 instances some times
//does not handle subtraction correctly (execute(-3-3)
